...
public class Type_factory__o_d_c_p_SamplesPerspectiveActivity__quals__j_e_i_Any_j_e_i_Default_j_i_Named extends Factory<SamplesPerspectiveActivity> { public Type_factory__o_d_c_p_SamplesPerspectiveActivity__quals__j_e_i_Any_j_e_i_Default_j_i_Named() {
    ...
    handle.setAssignableTypes(new Class[] { SamplesPerspectiveActivity.class, AbstractWorkbenchPerspectiveActivity.class, AbstractActivity.class, Object.class, Activity.class, RuntimeFeatureResource.class, RuntimeResource.class, Resource.class, PerspectiveActivity.class, ContextSensitiveActivity.class });
