...
public class Type_factory__o_d_c_e_e_ExternalDisplayerDragComponent__quals__j_e_i_Any_j_e_i_Default extends Factory<ExternalDisplayerDragComponent> { public Type_factory__o_d_c_e_e_ExternalDisplayerDragComponent__quals__j_e_i_Any_j_e_i_Default() {
  ...
  native static GlobalDisplayerSettings ExternalDisplayerDragComponent_GlobalDisplayerSettings_globalDisplayerSettings(ExternalDisplayerDragComponent instance) /*-{
    return instance.@org.dashbuilder.client.editor.external.ExternalDisplayerDragComponent::globalDisplayerSettings;
  }-*/;

  native static void ExternalDisplayerDragComponent_GlobalDisplayerSettings_globalDisplayerSettings(ExternalDisplayerDragComponent instance, GlobalDisplayerSettings value) /*-{
    instance.@org.dashbuilder.client.editor.external.ExternalDisplayerDragComponent::globalDisplayerSettings = value;
  }-*/;
}