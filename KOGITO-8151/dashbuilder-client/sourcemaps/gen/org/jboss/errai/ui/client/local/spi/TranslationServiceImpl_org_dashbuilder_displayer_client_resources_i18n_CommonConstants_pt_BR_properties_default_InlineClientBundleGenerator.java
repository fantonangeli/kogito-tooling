...
public class TranslationServiceImpl_org_dashbuilder_displayer_client_resources_i18n_CommonConstants_pt_BR_properties_default_InlineClientBundleGenerator implements org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_dashbuilder_displayer_client_resources_i18n_CommonConstants_pt_BR_properties {
  private static TranslationServiceImpl_org_dashbuilder_displayer_client_resources_i18n_CommonConstants_pt_BR_properties_default_InlineClientBundleGenerator _instance0 = new TranslationServiceImpl_org_dashbuilder_displayer_client_resources_i18n_CommonConstants_pt_BR_properties_default_InlineClientBundleGenerator();
  private void getContentsInitializer() {
    getContents = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/home/fantonan/.m2/repository/org/dashbuilder/dashbuilder-displayer-client/0.0.0/dashbuilder-displayer-client-0.0.0.jar!/org/dashbuilder/displayer/client/resources/i18n/CommonConstants_pt_BR.properties
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'getContents': return this.@org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_dashbuilder_displayer_client_resources_i18n_CommonConstants_pt_BR_properties::getContents()();
    }
    return null;
  }-*/;
}
