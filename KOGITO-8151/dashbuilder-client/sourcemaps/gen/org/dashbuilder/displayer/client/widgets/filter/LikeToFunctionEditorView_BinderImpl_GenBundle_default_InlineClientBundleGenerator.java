  ...
  private void styleInitializer() {
    style = new org.dashbuilder.displayer.client.widgets.filter.LikeToFunctionEditorView_BinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GD0PFO4BGR{font-size:" + ("small")  + ";}.GD0PFO4BFR{margin-top:" + ("0")  + ";margin-bottom:" + ("0")  + ";margin-left:" + ("5px")  + ";}")) : ((".GD0PFO4BGR{font-size:" + ("small")  + ";}.GD0PFO4BFR{margin-top:" + ("0")  + ";margin-bottom:" + ("0")  + ";margin-right:" + ("5px")  + ";}"));
      }
