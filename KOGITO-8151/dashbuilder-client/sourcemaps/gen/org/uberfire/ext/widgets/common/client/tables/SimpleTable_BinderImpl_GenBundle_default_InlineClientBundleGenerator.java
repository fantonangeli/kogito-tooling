  ...
  private void styleInitializer() {
    style = new org.uberfire.ext.widgets.common.client.tables.SimpleTable_BinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GD0PFO4BLS{padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.GD0PFO4BMS{height:" + ("32px")  + ";}.GD0PFO4BNS{float:" + ("left")  + ";text-align:" + ("left")  + ";}.GD0PFO4BKS{text-align:" + ("center")  + ";}")) : ((".GD0PFO4BLS{padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.GD0PFO4BMS{height:" + ("32px")  + ";}.GD0PFO4BNS{float:" + ("right")  + ";text-align:" + ("right")  + ";}.GD0PFO4BKS{text-align:" + ("center")  + ";}"));
      }
