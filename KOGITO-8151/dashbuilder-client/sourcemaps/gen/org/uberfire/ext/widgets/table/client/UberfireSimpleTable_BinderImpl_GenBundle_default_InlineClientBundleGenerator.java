  ...
  private void styleInitializer() {
    style = new org.uberfire.ext.widgets.table.client.UberfireSimpleTable_BinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GD0PFO4BPS{padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.GD0PFO4BAT{height:" + ("32px")  + ";}.GD0PFO4BBT{float:" + ("left")  + ";text-align:" + ("left")  + ";}.GD0PFO4BOS{text-align:" + ("center")  + ";}")) : ((".GD0PFO4BPS{padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.GD0PFO4BAT{height:" + ("32px")  + ";}.GD0PFO4BBT{float:" + ("right")  + ";text-align:" + ("right")  + ";}.GD0PFO4BOS{text-align:" + ("center")  + ";}"));
      }
