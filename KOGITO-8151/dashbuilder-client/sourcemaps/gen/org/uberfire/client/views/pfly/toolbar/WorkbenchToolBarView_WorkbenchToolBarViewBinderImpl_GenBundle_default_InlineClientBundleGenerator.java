  ...
  private void styleInitializer() {
    style = new org.uberfire.client.views.pfly.toolbar.WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GD0PFO4BPR{height:" + ("5px")  + ";}.GD0PFO4BNR{border-left-width:" + ("1px")  + " !important;border-bottom-width:" + ("1px")  + " !important;padding-left:" + ("0")  + " !important;}.GD0PFO4BAS{float:" + ("right")  + " !important;margin-top:" + ("0")  + " !important;margin-bottom:" + ("0")  + " !important;position:" + ("absolute")  + " !important;}.GD0PFO4BOR{float:" + ("left")  + ";border-left-width:" + ("1px")  + ";padding-left:") + (("1px")  + ";padding-right:" + ("1px")  + ";}")) : ((".GD0PFO4BPR{height:" + ("5px")  + ";}.GD0PFO4BNR{border-right-width:" + ("1px")  + " !important;border-bottom-width:" + ("1px")  + " !important;padding-right:" + ("0")  + " !important;}.GD0PFO4BAS{float:" + ("left")  + " !important;margin-top:" + ("0")  + " !important;margin-bottom:" + ("0")  + " !important;position:" + ("absolute")  + " !important;}.GD0PFO4BOR{float:" + ("right")  + ";border-right-width:" + ("1px")  + ";padding-right:") + (("1px")  + ";padding-left:" + ("1px")  + ";}"));
      }
